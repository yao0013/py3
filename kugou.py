...
def get_info(url):
    ...
    cursor = db.cursor() 
    sql = 'create table if not exists kugou3(ranks VARCHAR(255) NOT NULL, singer VARCHAR(255) NOT NULL, song VARCHAR(255) NOT NULL, time VARCHAR(255) NOT NULL, PRIMARY KEY (ranks))'
    cursor.execute(sql)
